...
// // const db = require('../models'); // Assuming you have a models file for your database

// // Admin login route
// // Example addition to log errors
...
//       const token = jwt.sign({ userId: admin.id, role: 'admin' }, 'your_secret_key', { expiresIn: '1h' });
